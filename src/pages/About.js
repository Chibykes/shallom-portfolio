...
function About() {
  ...
  return (
    <main className="">
            ...
            <div className="pt-40">
                ...
                <div className="grid lg:grid-cols-2 grid-cols-1 items-center py-10 lg:gap-16 gap-5">
                    <div className="col-span-1 min-h-fit overflow-hidden rounded-lg">
                        <img src={shallom} className="w-full h-auto" alt="Shallom Isaiah picture" />
                    </div>
                    <div className="col-span-1 overflow-hidden py-5 space-y-5">
                        <p className="font-[800] lg:text-4xl text-2xl lg:leading-[1.5] leading-[1.5]">
                        ...
                        <p className="font-[400] lg:text-base text-[15px]">
                            My name is Shallom Isaiah, I'm a visual and product designer currently based in Lagos, Nigeria. I'm a computer science major and google certified UX Designer who is user-obsessed and passionate about building seamless digital experiences that makes the user happy.
                            <br /><br />
        ...
        <section className="py-20 lg:px-16 px-8">
            <div className="grid lg:grid-cols-3 grid-cols-1 items-center lg:gap-40 gap-8">
                <div className="col-span-1">
                    <p className="font-bold text-2xl">Tools I Use</p>
                </div>

                <div className="col-span-2 space-y-12">
                    <img src={ matchMedia('(max-width: 600px)').matches ? tools : toolsDesktop } className="w-3/5" alt="Tools I use" />
                </div>
