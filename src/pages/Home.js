                        ...
                        return (
                            <motion.div className="grid lg:grid-cols-2 grid-cols-1 gap-x-24 lg:gap-y-0 gap-y-5 items-stretch relative" {...fadeIn}>
                                ...
                                <div className="col-span-1 lg:space-y-12 space-y-5 py-5">
                                    ...
                                    <div className="lg:px-10 lg:py-5 px-6 py-4 inline-flex justify-center items-center lg:gap-x-5 gap-x-3 lg:rounded-lg rounded-md bg-main-black text-white">
                                        <p className="font-semibold text-sm">View Case Study</p>
                                        <svg className="lg:scale-75 scale-50" width="51" height="16" viewBox="0 0 51 16" fill="none" xmlns="http://www.w3.org/2000/svg">
